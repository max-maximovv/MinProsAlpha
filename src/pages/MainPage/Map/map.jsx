...
export const MapInfo = (
  <>
    <div className="contacts-container">
      <h3>КОНТАКТЫ</h3>
      <p className="contacts-container-cont">
        <img src="" />
        Адрес Министерства
      ...
      <p className="contacts-container-text">
        ...
        управления образованием, руководителей организаций общего образования,
        педагогов и родителей по организации дистанционного обучения:{" "}
        <b>(533)22189</b>
      </p>
      <p className="contacts-container-text">
